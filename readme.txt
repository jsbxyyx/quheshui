window
python -m nuitka --mingw64 --standalone --windows-disable-console --onefile --include-data-dir=res=res --enable-plugin=pyside2 --nofollow-imports --output-dir=out --remove-output main.py
